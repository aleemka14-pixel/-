 ...
 * Houses supported USDT network limits, fees, addresses, active provider choice, and fallback defaults.
 */
export const WALLET_CONFIG = {
  // Provider setting: 'mock' (simulated node) or other live providers like hot, mpc, or custody
  activeProvider: process.env.ACTIVE_WALLET_PROVIDER || 'mock',
  
  // Overall default automatic withdrawal setting (can be overridden by Firestore admin state)
